<footer>
							...
							<div class="modal-login">
								<div class="form-group">
									<div class="input-group">
										...
										<input type="text" id="LoginFormName" name="email" class="form-control" placeholder="Name:">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group">
										...
										<input type="password" id="LoginFormPass" class="form-control" name="password" placeholder="Password:">
									</div>
								</div>
		...
		<div class="modal-compare">
			<div class="container">
				...
				<div class="row-content">
					<div class="item">
						<a href="#" class="img"><img src="<?php echo base_url('assets/theme/images/product/product-01.jpg') ?>" alt=""/></a>
		...
		<!-- /modalWishlist -->
		<script src="<?php echo base_url('assets/theme/external/jquery/jquery-2.1.4.min.js') ?>"></script>
		<script src="<?php echo base_url('assets/theme/external/bootstrap/bootstrap.min.js') ?>"></script>
		<script src="<?php echo base_url('assets/theme/external/countdown/jquery.plugin.min.js') ?>"></script>
		<script src="<?php echo base_url('assets/theme/external/countdown/jquery.countdown.min.js') ?>"></script>
		<script src="<?php echo base_url('assets/theme/external/slick/slick.min.js') ?>"></script>
		<script src="<?php echo base_url('assets/theme/external/rs-plugin/js/jquery.themepunch.tools.min.js') ?>"></script>
		<script src="<?php echo base_url('assets/theme/external/rs-plugin/js/jquery.themepunch.revolution.min.js') ?>"></script>
		<script src="<?php echo base_url('assets/theme/external/panelmenu/panelmenu.js') ?>"></script>
		<script src="<?php echo base_url('assets/theme/js/quick-view.js') ?>"></script>
